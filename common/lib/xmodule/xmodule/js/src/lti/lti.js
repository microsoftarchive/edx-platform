    ...
    this.LTI = function (element) {
        ...
        $(element).on('click', '.link_lti_new_window', function () {
            if(askToSendUsername && askToSendEmail) {
                return confirm(gettext("By clicking 'OK', your username and e-mail address will be sent to a 3rd party application.\n\nClick 'Cancel' to stay on this page."));
            } else if (askToSendUsername) {
                return confirm(gettext("By clicking 'OK', your username will be sent to a 3rd party application.\n\nClick 'Cancel' to stay on this page."));
            } else if (askToSendEmail) {
                return confirm(gettext("By clicking 'OK', your e-mail address will be sent to a 3rd party application.\n\nClick 'Cancel' to stay on this page."));
            } else {
                return true;
            }
        });
