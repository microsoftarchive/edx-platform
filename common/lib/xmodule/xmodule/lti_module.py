...
class LTIFields(object):
    ...
    *https://bc-staging.vitalsource.com/books/book*,
    ...
    ask_to_send_username = Boolean(
        ...
        help=_(
            "Requesting user's username will only work if 'Open in New Page' is set to True"
        ),
        default=False,
        scope=Scope.settings
    )
    ask_to_send_email = Boolean(
        ...
        help=_(
            "Requesting user's email will only work if 'Open in New Page' is set to True"
        ),
        default=False,
        scope=Scope.settings
    )
    ...
    button_text = String(
        ...
        help=_(
            "Allows you to override the default text ('View resource in a new window') on the button used to launch a third party app."
        ),
        default="",
        scope=Scope.settings
    )
